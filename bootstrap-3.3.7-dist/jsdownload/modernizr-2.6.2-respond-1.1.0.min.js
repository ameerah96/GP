...
window.Modernizr = function(a, b, c) {
    ...
    var d = "2.8.2",
        ...
        x, y = function(a, c, d, e) {
            ...
            return f = ["­", ', h, '">', a, ""].join(""), l.id = h, (m ? l : n).innerHTML += f, n.appendChild(l), m || (n.style.background = "", n.style.overflow = "hidden", k = g.style.overflow, g.style.overflow = "hidden", g.appendChild(n)), i = c(l, a), m ? l.parentNode.removeChild(l) : (n.parentNode.removeChild(n), g.style.overflow = k), !!i
        },
        z = function(b) {
    ...
    !E(A, "undefined") && !E(A.call, "undefined") ? B = function(a, b) {
        ...
        return a.innerHTML = "", (a.firstChild && a.firstChild.namespaceURI) == r.svg
...
window.matchMedia = window.matchMedia || (function(e, f) {
    ...
    d.appendChild(g);
    return function(h) {
        g.innerHTML = '­ + h + '"> #mq-test-1 { width: 42px; }';
        a.insertBefore(d, b);
        c = g.offsetWidth == 42;
        a.removeChild(d);
        return {
