...
<form class="form-inline">
  ...
  <p>
  Some Notes:</p>
  <p>1-By applying this form that does <strong>Not</strong> mean the course offically deleted.</p>
       <p>2-The form might take up to 3 working days.</p>
	   <hr>
<p>why do you want to delete the course?(please write your justification)</p>
...
<p id ="course_pre"> Course corequisite:</p>
